...
export function Login() {
    ...
    useEffect(() => {
        const req2FA = searchParams.get('requires_2fa') === 'true';
        const token = searchParams.get('2fa_token');
    ...
    const handleVerify2FA = async (e: React.FormEvent) => {
        ...
        setIsSubmitting(true);
        try {
            await verifyCode(twoFactorToken, otpCode);
            navigate('/dashboard');
        } catch (err) {
                        ...
                        <div className="relative z-10">
                            ...
                            {show2FA ? (
                                <form onSubmit={handleVerify2FA} className="space-y-5">
                                    ...
                                    <div>
                                        <label htmlFor="otp" className="block text-sm mb-2 text-center">
                                            Verification Code
                                        </label>
                                        <input
                                            id="otp"
                                            ...
                                            placeholder="000000"
                                            className="w-full bg-input-background border border-border rounded-lg px-4 py-4 text-center text-3xl font-bold tracking-[0.5em] focus:outline-none focus:ring-2 focus:ring-[#00ff88]/50 focus:border-[#00ff88] transition-all"
                                            required
                                            autoFocus
                                        />
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-gradient-to-r from-[#00ff88] to-[#14b8a6] hover:from-[#00ff88]/90 hover:to-[#14b8a6]/90 text-[#0a0e27] px-6 py-3 rounded-lg transition-all duration-200 shadow-lg shadow-[#00ff88]/20 hover:shadow-xl hover:shadow-[#00ff88]/30 font-semibold"
                                    >
